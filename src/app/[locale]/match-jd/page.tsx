    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-green-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          {/* Coming Soon Badge */}
          <div className="inline-flex items-center space-x-2 rtl:space-x-reverse bg-gradient-to-r from-green-100 to-emerald-100 rounded-full px-4 py-2 mb-8">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                <div className="bg-green-50 rounded-xl p-3 w-fit mb-4 mx-auto">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                <div className="bg-emerald-50 rounded-xl p-3 w-fit mb-4 mx-auto">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                <div className="bg-teal-50 rounded-xl p-3 w-fit mb-4 mx-auto">
            ...
            <div className="space-y-4">
              <p className="text-lg text-gray-700 font-medium">{t("notify")}</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  href={`/${locale}`}
                  className="group border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl font-semibold hover:bg-gray-50 hover:border-gray-400 transition-all duration-300 flex items-center justify-center gap-2"
                >
