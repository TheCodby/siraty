    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center space-x-2 rtl:space-x-reverse bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-full px-4 py-2 mb-6">
          ...
          {sections.map((section) => (
            ...
            >
              <div className="flex items-start space-x-4 rtl:space-x-reverse">
                <div className="bg-blue-50 dark:bg-blue-900/30 rounded-xl p-3 flex-shrink-0">
        ...
        {/* Contact Section */}
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:bg-gradient-to-r dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-8 mt-12 border border-blue-100 dark:border-blue-800/50 transition-colors duration-300">
