    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center space-x-2 rtl:space-x-reverse bg-gradient-to-r from-purple-100 to-indigo-100 rounded-full px-4 py-2 mb-6">
        ...
        {/* Contact Section */}
        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl p-8 mt-12 border border-purple-100">
